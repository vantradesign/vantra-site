...
/** Published products — excludes draft entries from navigation, listings and SEO. */
export const products = _allProducts.filter((p) => !p.draft)

export function findProduct(slug: string): Product | undefined {
  return _allProducts.find((product) => product.slug === slug)
}
