...
- There is no Nuxt Content collection, no CMS, and no `content/` directory. Do not introduce one. Do not add fields to `Product` for a single entry's convenience.
