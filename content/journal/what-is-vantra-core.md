...
Mostly no. If you are using a browser utility — the [Contrast Checker](/tools/contrast-checker), the type scale generator, the clamp() calculator — Core is not involved at all. Those tools are self-contained and compute everything in the browser.
