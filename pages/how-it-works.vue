  ...
  <div>
    ...
    <ChapterSection :chapter="chapter('the-tools')">
      ...
      <ChapterProse
        ...
        :paragraphs="[
          'The ten utilities are the small end. Contrast ratios, modular type scales, easing curves, clamp() values — the unglamorous arithmetic behind a design system, done properly and done in the browser. They need no install and no repository: you open one, get a value, copy it, and close the tab. Nothing is uploaded because there is nowhere for it to go.',
          'The products are the long end. The Accessibility Auto-Fixer reads a rendered page and proposes fixes as diffs you approve. The AI Design Reviewer compares a component against the system it claims to belong to. The Deprecation Lifecycle Orchestrator follows a removal from announcement to the last consumer. These read your repository through the core, which is why their findings cite your tokens instead of a generic rulebook.',
