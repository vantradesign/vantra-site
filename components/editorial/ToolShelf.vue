 ...
 * whole grid reads as a plain list of twenty links to a screen reader.
 */
...
<template>
  <section ref="root" aria-labelledby="shelf-heading" class="mt-section border-t border-rule pt-8 md:pt-10">
    <div class="gutter">
      <div class="md:grid md:grid-cols-12 md:items-end md:gap-x-8">
        <div class="md:col-span-7">
          ...
          <p class="mt-6 font-display text-display text-balance measure-tight">
            Twenty small instruments, off the shelf.
          </p>
        </div>
      ...
      <p class="mt-12">
        <AppLink to="/tools" accent="blue">All twenty tools</AppLink>
      </p>
    </div>
  </section>
</template>
